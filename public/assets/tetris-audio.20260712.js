...
export function createTetrisAudio(options = {}) {
  ...
  function playEffect(name, intensity = 1) {
    ...
    switch (name) {
      ...
      case "rowBlast":
        playTone(196, 0.08, 0.04, "sawtooth");
        return playTone(98, 0.2, 0.05, "triangle", 0.06);
      case "queueShift":
        playTone(392, 0.07, 0.035, "square");
        return playTone(587.33, 0.12, 0.04, "square", 0.06);
      case "slowTime":
        playTone(440, 0.12, 0.035, "sine");
        return playTone(220, 0.24, 0.04, "sine", 0.08);
      default:
        return false;
    }
  }
